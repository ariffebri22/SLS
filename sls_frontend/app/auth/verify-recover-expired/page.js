    ...
    return (
        <div className="min-h-screen flex items-center justify-center text-center px-4">
            <div className="max-w-md border p-6 rounded-4xl shadow border-neutral-300 font-poppins flex flex-col items-center">
                ...
                <h1 className="text-2xl font-bold text-red-600 mb-4">In invalid or expired activation link</h1>
                <p className="mb-6 text-gray-700">The token used may have expired or ever used.</p>
